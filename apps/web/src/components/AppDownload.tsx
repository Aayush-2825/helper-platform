        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="#" className="flex items-center gap-3 bg-white text-zinc-900 font-bold px-5 py-3.5 rounded-[12px] hover:bg-white/90 transition-all hover:shadow-lg hover:shadow-white/10">
                ...
                <div className="px-4 space-y-3">
                  <div className="bg-white/10 rounded-[12px] p-3">
                    ...
                    <div className="flex items-center gap-2">
                      <img src="https://randomuser.me/api/portraits/men/32.jpg" className="size-7 rounded-full border border-white/30" alt="helper" />
                      <div>
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {["Cleaning", "Electric", "Plumbing"].map((s) => (
                      <div key={s} className="bg-white/10 rounded-[8px] py-2 text-center">
