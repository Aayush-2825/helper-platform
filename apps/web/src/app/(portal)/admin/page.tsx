  ...
  return (
    <div className="space-y-12">
      <div className="reveal-up space-y-2 px-1">
        <h2 className="text-4xl font-heading font-black tracking-tight">Marketplace <span className="text-primary">Control</span></h2>
        <p className="text-muted-foreground font-medium">Manage global operations, verify providers, and handle service disputes.</p>
      </div>
      ...
      <div className="reveal-up delay-3 pt-12 border-t border-border/40 text-center opacity-40 selection:bg-teal-500">
         <p className="text-[10px] font-black uppercase tracking-[0.2em]">Administrative Security Protocol v2.4.0 (Teal Branch)</p>
      </div>
    </div>
  );
}
