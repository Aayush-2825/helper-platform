            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                  <div className="surface-card p-4 rounded-2xl border border-border/50 text-center space-y-1">
                      <p className="text-xs font-bold text-muted-foreground uppercase">Start Job OTP</p>
                      <p className="text-2xl font-black tracking-widest text-primary">{startOTP || "----"}</p>
                  </div>
                  <div className="surface-card p-4 rounded-2xl border border-border/50 text-center space-y-1">
                      <p className="text-xs font-bold text-muted-foreground uppercase">Complete Job OTP</p>
              ...
              {location && (
                <div className="rounded-3xl overflow-hidden border border-border/50 shadow-inner h-64 relative group">
                  <TrackingMap 
                    ...
                    helperId={helperId}
                  />
                  <div className="absolute bottom-4 left-4 right-4 bg-background/80 backdrop-blur-md p-3 rounded-2xl text-xs font-bold uppercase tracking-wider text-center border border-white/20 shadow-xl opacity-0 group-hover:opacity-100 transition-opacity">
