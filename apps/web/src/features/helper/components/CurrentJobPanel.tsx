      ...
      <Card className="surface-card-strong border-none overflow-hidden shadow-2xl relative">
        ...
        <div className="p-6 space-y-6">
          <div className="space-y-4">
            ...
            <div className="space-y-3 bg-muted/20 p-4 rounded-3xl border border-border/50">
          ...
          <div className="space-y-4">
            ...
            {error && (
              <p className="text-xs font-bold text-destructive text-center animate-shake">{error}</p>
            )}
          </div>
