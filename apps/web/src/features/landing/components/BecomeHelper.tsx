          ...
          <div className="space-y-8">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {HELPER_BENEFITS.map((b) => (
                <div key={b.title} className="bg-muted/40 border border-border rounded-lg p-5 space-y-3 hover:border-orange-200 hover:bg-orange-50/30 transition-all">
                  <div className="size-10 rounded-md bg-orange-50 border border-orange-100 flex items-center justify-center">
            ...
            <Link
              href="/helper"
              className="inline-flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white font-bold px-8 py-4 rounded-lg transition-all shadow-lg shadow-orange-500/20 text-base"
            >
