                ...
                <div className="flex items-center gap-3 pt-3 border-t border-border/60">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      {r.verified && (
                        <span className="shrink-0 text-xs font-black text-emerald-600 bg-emerald-50 border border-emerald-100 px-1.5 py-0.5 rounded-full">✓ Verified</span>
                      )}
                    </div>
                    <p className="text-xs text-muted-foreground font-medium">{r.city} · {r.service}</p>
                  </div>
                  <span className="text-xs text-muted-foreground/60 font-medium shrink-0">{r.date}</span>
                </div>
              </div>
            ))}
          </div>
