              ...
              return (
                ...
                >
                  <div className="flex items-start gap-5">
                    {/* Icon */}
                    <div className={`shrink-0 size-12 rounded-lg border flex items-center justify-center transition-all duration-300 ${
            ...
            <div className="relative w-full max-w-sm mx-auto space-y-4">
              ...
              <div className="bg-background border border-border rounded-xl p-5 shadow-sm">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div className="ml-auto flex items-center gap-1.5 text-xs font-bold text-muted-foreground">
              ...
              <div className={`bg-background border rounded-xl p-5 shadow-sm transition-all duration-500 ${
                ...
                {isMatched && (
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-bold text-foreground text-sm">{helper.name}</p>
              ...
              <div className="flex items-center justify-center gap-3 pt-2 flex-wrap">
                {["Background Verified", "Insured", "5-Star Rated"].map((t) => (
                  <div key={t} className="flex items-center gap-1.5 text-xs font-bold text-muted-foreground bg-muted/60 border border-border px-3 py-1.5 rounded-full">
                    <ShieldCheck className="size-3 text-emerald-500" />
                    {t}
                  </div>
                ))}
