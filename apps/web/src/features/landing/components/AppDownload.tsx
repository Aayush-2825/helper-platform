        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/help#app-download" className="flex items-center gap-3 bg-white text-zinc-900 font-bold px-5 py-3.5 rounded-lg hover:bg-white/90 transition-all hover:shadow-lg hover:shadow-white/10" aria-label="Get iOS app launch updates">
                ...
                <div>
                  <p className="text-xs font-semibold text-zinc-600 leading-none mb-0.5">Download on the</p>
                  <p className="text-lg font-black leading-none">App Store</p>
                </div>
              </Link>

              <Link href="/help#app-download" className="flex items-center gap-3 bg-white text-zinc-900 font-bold px-5 py-3.5 rounded-lg hover:bg-white/90 transition-all hover:shadow-lg hover:shadow-white/10" aria-label="Get Android app launch updates">
                ...
                <div>
                  <p className="text-xs font-semibold text-zinc-600 leading-none mb-0.5">Get it on</p>
          ...
          <div className="flex justify-center lg:justify-end relative">
            <div className="relative w-65">
              {/* Phone frame */}
                <div className="w-full aspect-9/19 bg-white/10 border border-white/20 rounded-4xl relative overflow-hidden shadow-2xl shadow-black/40 backdrop-blur">
                {/* Status bar */}
                ...
                <div className="px-4 space-y-3">
                    ...
                    <p className="text-white/50 text-xs font-bold uppercase tracking-wider mb-1">Tracking Helper</p>
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <p className="text-white text-sm font-bold">Suresh Mehta</p>
                        <p className="text-white/50 text-xs">Arriving in 4 mins</p>
                      </div>
                    ...
                    <p className="text-white font-black text-sm">Book a Service</p>
                    <p className="text-white/70 text-xs mt-0.5">Helper in 10 mins</p>
                  </div>
              ...
              {/* Floating notification */}
                      <div className="absolute -right-8 top-16 bg-white rounded-lg px-3 py-2.5 shadow-xl flex items-center gap-2 w-48">
                ...
                <div>
                          ...
                          <p className="text-xs text-zinc-500 font-medium mt-0.5">Rate your helper</p>
                </div>
              </div>
            </div>
          </div>
