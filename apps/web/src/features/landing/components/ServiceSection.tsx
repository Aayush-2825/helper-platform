    ...
    <section id="services" className="scroll-mt-24 py-24 px-6 border-t border-border bg-muted/20">
      <div className="max-w-7xl mx-auto space-y-10">
        ...
        <div className="relative max-w-2xl">
          <div className="flex items-center gap-3 bg-background border border-border rounded-lg px-4 py-3.5 shadow-sm focus-within:ring-2 focus-within:ring-primary/30 focus-within:border-primary/50 transition-all duration-200">
        ...
        {!isSearching && (
          <div className="inline-flex bg-muted p-1.5 rounded-lg shadow-sm w-full md:w-auto">
            <Button
              type="button"
              variant="ghost"
        ...
        {noResults ? (
          <div className="flex flex-col items-center justify-center py-20 gap-6 text-center">
            ...
            <Button
              type="button"
              onClick={() => setSearchQuery("")}
              className="px-5 py-2.5 rounded-md text-sm font-bold bg-primary text-primary-foreground hover:opacity-90"
            >
              ...
              >
                {srv.image ? (
                  <div className="relative w-full h-45 bg-muted shrink-0 overflow-hidden">
                    ...
                    {srv.badge && (
                      <span className="absolute top-3 right-3 px-3 py-1 text-xs font-black tracking-wide uppercase rounded-full bg-white/90 text-zinc-900 shadow-sm">
                        {srv.badge}
                      </span>
                    )}
                    <div className="absolute top-3 left-3 size-10 rounded-md bg-white/20 backdrop-blur-md flex items-center justify-center text-white border border-white/20">
                      <srv.icon className="size-5" strokeWidth={2.5} />
                    </div>
                  </div>
                ) : (
                  <div className="p-5 pb-0 flex items-start justify-between">
                    <div className="size-12 rounded-lg border border-border bg-muted/50 group-hover:bg-primary/5 flex items-center justify-center text-foreground group-hover:text-primary transition-colors">
                ...
                <div className="p-5 flex flex-col justify-between flex-1">
                  <div className="space-y-1">
                    ...
                    <div className="flex items-center gap-1.5 bg-accent/10 text-accent px-2.5 py-1 rounded-md text-sm font-bold">
                      Book Now
                    </div>
