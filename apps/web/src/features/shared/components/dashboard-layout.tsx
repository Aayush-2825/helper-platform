    ...
    <div className="flex min-h-dvh flex-col bg-background selection:bg-primary selection:text-white">
      ...
      <div className="relative flex flex-1 overflow-hidden">
        ...
        <aside className="relative hidden w-76 border-r border-border/40 bg-card/20 backdrop-blur-3xl lg:block">
          ...
          <div className="absolute top-0 -left-20 w-40 h-40 bg-primary/10 blur-2xl rounded-full pointer-events-none" />
        ...
        <main className="relative flex-1 overflow-hidden">
          ...
          <div className={cn(
            "absolute -top-40 -right-40 w-96 h-96 blur-3xl rounded-full opacity-20 pointer-events-none -z-10 animate-pulse",
